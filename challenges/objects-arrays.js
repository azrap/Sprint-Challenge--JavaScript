...
largerPopulation=zooAnimals.filter(ele => ele["population"]<5);
...
populationTotal=zooAnimals.reduce((acc,ele)=> {
...
// ticketPriceTotal=runners.reduce( (acc,ele) =>{
//   return acc + ele["donation"];
//   },0)
